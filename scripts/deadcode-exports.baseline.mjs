...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "extensions/tee-vault/src/audit/tee-audit.ts: collectContainerHardeningFindings",
  "extensions/tee-vault/src/audit/tee-audit.ts: SecurityAuditFinding",
  "extensions/tee-vault/src/constants.ts: BACKEND_SECURITY_ORDER",
  "extensions/tee-vault/src/constants.ts: HSM_AUTH_KEY_ADMIN",
  "extensions/tee-vault/src/constants.ts: HSM_AUTH_KEY_BACKUP",
  "extensions/tee-vault/src/constants.ts: HSM_AUTH_KEY_DB_CRYPTO",
  "extensions/tee-vault/src/constants.ts: HSM_AUTH_KEY_SSH_SIGNER",
  "extensions/tee-vault/src/constants.ts: IRONKEY_BACKUP_MANIFEST",
  "extensions/tee-vault/src/constants.ts: OPENBAO_DEFAULT_ADDR",
  "extensions/tee-vault/src/constants.ts: OPENBAO_DEFAULT_KV_MOUNT",
  "extensions/tee-vault/src/constants.ts: OPENBAO_DEFAULT_TRANSIT_MOUNT",
  "extensions/tee-vault/src/constants.ts: SUPPORTED_SSH_ALGORITHMS",
  "extensions/tee-vault/src/constants.ts: YUBIHSM_SHELL_PATH",
  "extensions/tee-vault/src/crypto/key-hierarchy.ts: deriveKeyFromPassphrase",
  "extensions/tee-vault/src/crypto/openssl-bridge.ts: isOpensslAvailable (opensslBridge)",
  "extensions/tee-vault/src/crypto/openssl-bridge.ts: SshKeyPair (opensslBridge)",
  "extensions/tee-vault/src/crypto/yubihsm.ts: getHsmInfo (yubiHsm)",
  "extensions/tee-vault/src/crypto/yubihsm.ts: hsmUnwrapKey",
  "extensions/tee-vault/src/crypto/yubihsm.ts: hsmWrapKey",
  "extensions/tee-vault/src/integrations/credential-manager.ts: CREDENTIAL_TARGETS (credentialManager)",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: BackupManifest",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: createWrapKey",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: exportWrappedObject",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: importRawWrapKey",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: importWrappedObject",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: secureDelete (ironkeyBackup)",
  "extensions/tee-vault/src/integrations/ironkey-backup.ts: WrappedObjectInfo (ironkeyBackup)",
  "extensions/tee-vault/src/integrations/openbao.ts: kvDelete",
  "extensions/tee-vault/src/integrations/openbao.ts: kvGet",
  "extensions/tee-vault/src/integrations/openbao.ts: kvList",
  "extensions/tee-vault/src/integrations/openbao.ts: kvPut",
  "extensions/tee-vault/src/integrations/openbao.ts: OpenbaoConfig",
  "extensions/tee-vault/src/integrations/openbao.ts: OpenbaoHealthResponse",
  "extensions/tee-vault/src/integrations/openbao.ts: OpenbaoSealStatus",
  "extensions/tee-vault/src/integrations/openbao.ts: TransitDecryptResponse (openbao)",
  "extensions/tee-vault/src/integrations/openbao.ts: TransitEncryptResponse",
  "extensions/tee-vault/src/integrations/openbao.ts: transitSign",
  "extensions/tee-vault/src/integrations/openbao.ts: transitVerify (openbao)",
  "extensions/tee-vault/src/integrations/ssh-config.ts: generateMcpSshConfig (sshConfig)",
  "extensions/tee-vault/src/integrations/ssh-config.ts: generateSshConfigBlock",
  "extensions/tee-vault/src/integrations/ssh-config.ts: getSshConfigPath",
  "extensions/tee-vault/src/integrations/ssh-config.ts: SshHostConfig (sshConfig)",
  "extensions/tee-vault/src/types.ts: AuditCheck",
  "extensions/tee-vault/src/types.ts: CredentialTarget",
  "extensions/tee-vault/src/types.ts: HsmAuthKeyRole",
  "extensions/tee-vault/src/types.ts: HsmKeyMapping",
  "extensions/tee-vault/src/types.ts: MostlySecureConfig",
  "extensions/tee-vault/src/types.ts: OpenbaoIntegrationConfig",
  "extensions/tee-vault/src/types.ts: SshHostEntry",
  "extensions/tee-vault/src/types.ts: VaultConfig",
  "extensions/tee-vault/src/types.ts: VaultMetadata",
  "extensions/tee-vault/src/vault/vault-entries.ts: EntryMetadata (vaultEntries)",
  "extensions/tee-vault/src/vault/vault-entries.ts: StoreEntryParams",
  "extensions/tee-vault/src/vault/vault-lock.ts: getUnlockedAt (vaultLock)",
  "extensions/tee-vault/src/vault/vault-store.ts: computeEnvelopeHmac (vaultStore)",
  "extensions/tee-vault/src/vault/vault-store.ts: resolveVaultDir",
  ...
  "src/agents/sandbox/wasm-backend.ts: buildWasmHttpArgv",
  "src/agents/sandbox/wasm-backend.ts: DEFAULT_WASM_SANDBOX_ALLOWLIST",
  "src/agents/sandbox/wasm-backend.ts: DEFAULT_WASM_SANDBOX_BIN",
  "src/agents/sandbox/wasm-backend.ts: DEFAULT_WASM_SANDBOX_MAX_BYTES",
  "src/agents/sandbox/wasm-backend.ts: DEFAULT_WASM_SANDBOX_TIMEOUT_SECS",
  "src/agents/sandbox/wasm-backend.ts: resolveWasmSandboxAllowlist",
  "src/agents/sandbox/wasm-backend.ts: resolveWasmSandboxBin",
  "src/agents/sandbox/wasm-backend.ts: tryParseCurlHttpsUrl",
  ...
  "src/agents/tools/sokosumi/types.ts: JobStatus",
  "src/agents/tools/sokosumi/types.ts: JobType",
  ...
  "ui/src/components/config-form.ts: SECTION_META",
  ...
  "ui/src/components/settings-ui.ts: SettingsRowControl",
  "ui/src/components/settings-ui.ts: SettingsRowProps",

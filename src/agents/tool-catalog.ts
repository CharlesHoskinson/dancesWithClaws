...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "sokosumi_list_agents",
    label: "sokosumi_list_agents",
    description: "List Sokosumi marketplace agents",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "sokosumi_get_agent",
    label: "sokosumi_get_agent",
    description: "Get Sokosumi agent details and pricing",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "sokosumi_get_input_schema",
    label: "sokosumi_get_input_schema",
    description: "Get Sokosumi agent input schema",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "sokosumi_list_jobs",
    label: "sokosumi_list_jobs",
    description: "List Sokosumi jobs",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "sokosumi_create_job",
    label: "sokosumi_create_job",
    description: "Create a Sokosumi marketplace job",
    sectionId: "agents",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
